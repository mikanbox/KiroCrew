...
installed by the synchronous spawn shim after exec. Outside a pod, Azure CLI
configuration and extension visibility stays within the protected canonical
