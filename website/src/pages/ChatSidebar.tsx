...
function ChatSidebar({
  ...
  const filterCounts = useMemo(() => {
    ...
    // (`!slot.instance_id && …`), so widening the collection cannot add a match —
  ...
  const filteredSlots = useMemo(() => {
    ...
    [allRows, filterDimensions, searchRanked, pinned, sortKey, dragFrozen]
  )
  ...
  }, [reorderFolders, moveByDrag, moveFolderByDrag, localSlots, activeSlot, onDropSessionRef])
